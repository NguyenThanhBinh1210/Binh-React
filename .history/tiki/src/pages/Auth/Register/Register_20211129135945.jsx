...
import 				<InputNumber type="text" name="number" placeholder="Số điện thoại" />
 from 'src/Components/Input/				<InputNumber type="text" name="number" placeholder="Số điện thoại" />
'
