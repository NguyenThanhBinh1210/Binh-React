...
export default function Navbar() {
	...
	return (
		<S.Navbar>
			<S.NavConnection>
				<S.ConnectLink to={path.home}>Kênh người bán</S.ConnectLink>
				<S.ConnectLink to={path.home}>Trở thành người bán Shopee</S.ConnectLink>
				<S.ConnectLink to={path.home}>Tải ứng dụng</S.ConnectLink>
				<S.ConnectLink to={path.home}>Kết nối</S.ConnectLink>
			</S.NavConnection>
			<S.NavMenu>
				<li>Thông báo</li>
				<li>Hỗ trợ</li>
