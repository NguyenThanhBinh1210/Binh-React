...
export default function Navbar() {
	...
	return (
		<S.Navbar>
			<S.NavConnection>
				<S.ConnectLink to={path.register}>Kênh người bán</S.ConnectLink>
				<S.ConnectLink to={path.register}>
					Trở thành người bán Shopee
				</S.ConnectLink>
				<S.ConnectLink to={path.register}>Tải ứng dụng</S.ConnectLink>
				<S.ConnectLink to={path.register}>Kết nối</S.ConnectLink>
			</S.NavConnection>
			<S.NavMenu>
				<li>Thông báo</li>
				<li>Hỗ trợ</li>
