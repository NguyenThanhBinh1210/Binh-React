...
export default function Navbar() {
	...
	return (
		<S.Navbar>
			<S.NavConnection>
				<S.ConnectLink>Kênh người bán</S.ConnectLink>
				<S.ConnectLink>Trở thành người bán Shopee</S.ConnectLink>
				<S.ConnectLink>Tải ứng dụng</S.ConnectLink>
				<S.ConnectLink>Kết nối</S.ConnectLink>
			</S.NavConnection>
			<S.NavMenu>
				<li>Thông báo</li>
				<li>Hỗ trợ</li>
