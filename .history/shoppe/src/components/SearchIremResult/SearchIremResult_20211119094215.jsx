...
export default function SearchIremResult({ products, filters }) {
	...
	return (
		<div>
			<S.SortBar>
				...
				<S.SortByOptions>
					<S.SortByOptionsOption onClick={() => sortBy('view')}>
						Phổ biến
					</S.SortByOptionsOption>
					<S.SortByOptionsOption onClick={() => sortBy('createAt')}>
						Mới nhất
					</S.SortByOptionsOption>
					<S.SortByOptionsOption onClick={() => sortBy('sold')}>
						Bán chạy
					</S.SortByOptionsOption>
					<S.SortByPrice>
